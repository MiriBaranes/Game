...
public class Cannon {
    ...
    public final static int CRAFT_W = 100;
    public final static int CRAFT_H = 60;
    ...
    public final static int SEAT_H = 20;
    public final static int SEAT_W = 50;
    public final static int SEAT_X = CRAFT_X + (CRAFT_W -  SEAT_W)/2;
    public final static int SEAT_Y = CRAFT_Y + 10;
    public final static int ALIEN_BODY_W = 15;
    public final static int ALIEN_BODY_H = 25;
    public final static int ALIEN_BODY_X = CRAFT_X + (CRAFT_W - ALIEN_BODY_W)/2;
    public final static int ALIEN_BODY_Y = CRAFT_Y + 18;
    public final static int ALIEN_NECK_W = 6;
    public final static int ALIEN_NECK_H = 5;
    ...
    public final static int ALIEN_HEAD_W = 50;
    public final static int ALIEN_HEAD_H = 30;
